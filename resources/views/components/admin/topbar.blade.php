<header class="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 shadow-sm z-10">
    <div class="flex items-center">
        <button @click="sidebarOpen = true" class="text-gray-500 focus:outline-none lg:hidden hover:text-orange-600 transition-colors">
    ...
    <div class="flex items-center">
        <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            <button @click="dropdownOpen = !dropdownOpen" class="flex items-center space-x-2 text-gray-500 hover:text-orange-600 focus:outline-none transition-colors">
                <span class="font-medium text-sm sm:text-base">{{ Auth::user()->name }}</span>
