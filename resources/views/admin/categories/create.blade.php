        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-secondary focus:ring focus:ring-secondary/20 bg-gray-50 transition outline-none" placeholder="Contoh: Signature Burger">
